...
"""
=======================================test=======================================
mae: 69.24725274725274 mse: 115.33722653235522 time: 436.19699573516846 best mae: 69.24725274725274
=======================================test=======================================

======================================= Rep =======================================
mae: 69.24725274725274 mse: 115.33722653235522 time: 179.08999848365784 best mae: 69.24725274725274
=======================================test=======================================
"""
# part B
"""
...
def get_args_parser():
    ...
    # * Backbone
    parser.add_argument('--backbone', default='vgg16_bn_lite2', type=str,
    ...
    parser.add_argument('--output_dir', default='vis/output_240402-lite2-repvgg2-02',
    ...
    # 尝试加载预训练权重，会不会好点
    parser.add_argument('--pretrain', default='weights/240402-lite2-repvgg2-02/best_mae.pth', help='load pretrained weight from checkpoint')
...
def main(args):
    ...
    from models.p2pnet_v17_lite2_repvgg2 import P2PNet
    ...
    from models.p2pnet_v17_lite2_repvgg2 import repvgg_model_convert
